 ...
 * @website https://github.com/Torca2001/BD-Transcoder
 * @source https://raw.githubusercontent.com/Torca2001/BD-Transcoder/main/Transcoder.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
@else@*/
const config = {"main":"index.js","info":{"name":"Transcoder","authors":[{"name":"Torca","discord_id":"97842053588713472","github_username":"Torca"}],"version":"0.1.3","description":"Transcode uploaded videos to fit within file size limit","github":"https://github.com/Torca2001/BD-Transcoder","github_raw":"https://raw.githubusercontent.com/Torca2001/BD-Transcoder/main/Transcoder.plugin.js"},"changelog":[{"title":"More Features","items":["Added nvenc encoding"]}],"defaultConfig":[{"type":"switch","id":"renameFileExt","value":"true","name":"Fix extension type","note":"Fix video file extensions to ensure embed"},{"type":"switch","id":"compressImages","value":"false","name":"Always Compress images","note":"Any uploaded images will be compressed to webp, otherwise only compress images that exceed file upload size"},{"type":"textbox","id":"imageQuality","value":"90","name":"Image quality","note":"1 - 100, Webp image compression quality"},{"type":"switch","id":"twoPassEncode","value":"false","disabled":"true","name":"Two pass encode","note":"Whether to use two pass encoding. Doubles encode time but does improve compression"},{"type":"dropdown","id":"codec","value":"libx264","name":"Codec","note":"Type of codec to compress","options":[{"label":"H264","value":"libx264"},{"label":"VP9","value":"libvpx-vp9"},{"label":"H264 Nvenc","value":"h264_nvenc"}]},{"type":"textbox","id":"maxfps","value":"30","name":"Max fps","note":"Limit the videos fps to improve compression"},{"type":"textbox","id":"maxWidth","value":"","name":"Max Width","note":"Scale down videos to this width to save on size, maintains aspect ratio. Leave blank to turn this off"},{"type":"textbox","id":"maxHeight","value":"","name":"Max Height","note":"Scale down videos to this height to save on size, maintains aspect ratio. Leave blank to turn this off"},{"type":"textbox","id":"targetFileSize","value":"","name":"Target size","note":"File size to target compression for in MB, this is capped by whatever your max file upload size is normal: 8MB, Nitro: 100MB"},{"type":"textbox","id":"targetMultipler","value":"0.97","name":"Overhead multiplier","note":"Scaling factor to accomodate the file overhead for the compression"},{"type":"textbox","id":"bitrateMin","value":"1800","name":"Minimum bitrate (kbps)","note":"Lowest bitrate compression will be allowed to go, will start to limit time to ensure the bitrate is kept for the size"},{"type":"textbox","id":"bitrateMax","value":"16000","name":"Maximum bitrate (kbps)","note":"Maximum bitrate to not waste time trying to encode for an insane quality"}]};
class Dummy {
